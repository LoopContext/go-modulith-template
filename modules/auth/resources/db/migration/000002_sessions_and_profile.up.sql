...
CREATE INDEX idx_pending_contact_changes_user_id ON pending_contact_changes(user_id);
CREATE INDEX idx_pending_contact_changes_expires_at ON pending_contact_changes(expires_at);
