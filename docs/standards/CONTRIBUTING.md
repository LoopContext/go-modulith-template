...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/LoopContext/go-modulith-template.git
...
- For distributed consistency (reliable events and multi-step compensation), use the [Saga & Outbox pattern](../architecture/SAGA_AND_OUTBOX_ARCHITECTURE.md)
